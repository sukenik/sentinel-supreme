...
export const ENV_VARS = {
	...
	GATEWAY_THROTTLE_SHORT_TTL: 'THROTTLE_SHORT_TTL',
	GATEWAY_THROTTLE_SHORT_LIMIT: 'THROTTLE_SHORT_LIMIT',
	GATEWAY_THROTTLE_LONG_TTL: 'THROTTLE_LONG_TTL',
	GATEWAY_THROTTLE_LONG_LIMIT: 'THROTTLE_LONG_LIMIT'
}
